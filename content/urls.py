...
urlpatterns = [
    ...
    url(r'^contents/(?P<content_slug>[-\w]+)$', ContentDetail.as_view(), name="content_detail"),
    url(r'^librarys/$', LibraryListing.as_view(), name="library_listing"),
    url(r'^librarys/$(?P<library_item_slug>[-\w]+)', LibraryDetail.as_view(), name="library_detail"),
]
